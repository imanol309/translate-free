...
export default function NavBar() {
  return (
    <main className="flex flex-col w-[17%] h-full border-r border-gray-800">
      <section className="w-full h-[90%] flex flex-col gap-[3%] justify-start items-center py-[7%]">
        {listNavBar?.map((list) => (
          <Link
            key={list.id}
            href={list.url}
      ...
      <section className="w-full h-[10%] flex flex-col gap-12 justify-start items-center">
        <div className="w-[70%] flex items-center justify-start gap-4 cursor-pointer hover:bg-red-600 hover:text-white text-gray-500 rounded-full py-[2%] pl-5">
